...
import {
  AirportsPagedListRequest,
  AirportsService,
  LocalStorageStateService,
  QueryStringStateService,
  SessionStorageStateService
} from '../../shared';

@Component({
  providers: [
    { provide: RTStateService, useClass: LocalStorageStateService, multi: true },
    { provide: RTStateService, useClass: QueryStringStateService, multi: true },
    { provide: RTStateService, useClass: SessionStorageStateService, multi: true }
  ],
