...
@NgModule({
  declarations: [FiltersComponent, FiltersSampleComponent, CoerceSampleComponent, DefaultValueSampleComponent, EmptyIsNullSampleComponent, IgnoreOnAutoMapSampleComponent, OmitIfNullSampleComponent, ParameterNameSampleComponent, RegisterAsFilterSampleComponent],
  exports: [FiltersComponent, FiltersSampleComponent, CoerceSampleComponent, DefaultValueSampleComponent, EmptyIsNullSampleComponent, IgnoreOnAutoMapSampleComponent, OmitIfNullSampleComponent, ParameterNameSampleComponent, RegisterAsFilterSampleComponent],
